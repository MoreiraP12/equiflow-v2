...
def test_order_vars():
    ...
    # Add exclusions
    ef_default.add_exclusion(keep=exclusion1, exclusion_reason="Age < 18")
    ef_default.add_exclusion(keep=exclusion2, exclusion_reason="Glucose >= 200")
    ...
    ef_ordered.add_exclusion(keep=exclusion1, exclusion_reason="Age < 18")
    ef_ordered.add_exclusion(keep=exclusion2, exclusion_reason="Glucose >= 200")
