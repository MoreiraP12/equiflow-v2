...
def test_equiflow_pvalues():
    ...
    pvalues_none = ef.view_table_pvalues(correction="none")
    print("No correction - done")
    
    pvalues_bonf = ef.view_table_pvalues(correction="bonferroni")
    print("Bonferroni correction - done")
    
    pvalues_fdr = ef.view_table_pvalues(correction="fdr_bh")
    print("FDR (Benjamini-Hochberg) correction - done")
